...
- (void)viewDidLoad
{
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Roundhouse Memorial Park trails"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Raton Regional Aquatic Center"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Raton High School Track"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Boardwalk & River Walk Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Coal Camp Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Nature Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Raton Municipal Golf Course"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Climax Canyon Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Lake Alice Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Lake to Lake Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Deer Run Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Vista Grande Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Lake Maloya Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Wapiti Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Opportunity Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Ponderosa Ridge Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Lava Flow Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Crater Vent Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Crater Rim Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Scenic Drive"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Little Horse Mesa Trail"]) {
    ...
    if ([_TitleLabelSCT.text isEqualToString:@"Boca Trail"]) {
